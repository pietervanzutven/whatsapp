require((exports, module) => {
    ...
    const areJidsSameUser = (jid1, jid2) => {
        var _a, _b;
        return (((_a = exports.jidDecode(jid1)) === null || _a === void 0 ? void 0 : _a.user) === ((_b = exports.jidDecode(jid2)) === null || _b === void 0 ? void 0 : _b.user));
    };
    ...
    const jidNormalizedUser = (jid) => {
        const { user, server } = exports.jidDecode(jid);
        return exports.jidEncode(user, server === 'c.us' ? 's.whatsapp.net' : server);
    };
