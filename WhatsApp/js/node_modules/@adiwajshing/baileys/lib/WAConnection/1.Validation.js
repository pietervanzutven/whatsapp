require((exports, module) => {
    ...
    const Curve = __importStar(require("curve25519-js/lib"));
        ...
        validateNewConnection(json) {
            ...
            if (!json.secret) {
                ...
                if (json.clientToken && json.clientToken !== this.authInfo.clientToken) {
                    this.authInfo = Object.assign({}, this.authInfo, { clientToken: json.clientToken });
                }
                if (json.serverToken && json.serverToken !== this.authInfo.serverToken) {
                    this.authInfo = Object.assign({}, this.authInfo, { serverToken: json.serverToken });
                }
