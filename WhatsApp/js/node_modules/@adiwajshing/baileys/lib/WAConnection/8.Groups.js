    ...
    class WAConnection extends _7_MessagesExtra_1.WAConnection {
        constructor() {
            ...
            this.fetchGroupMetadataFromWA = async (jid) => {
                ...
                metadata.participants = metadata.participants.map(p => (Object.assign({}, this.contactAddOrGet(p.id), p)));
                return metadata;
            };
            ...
            this.groupMetadataMinimal = async (jid) => {
                ...
                return {
                    ...
                    participants: participants.map(item => (Object.assign({}, this.contactAddOrGet(item[1].jid), { isAdmin: item[1].type === 'admin' })))
                };
            };
            /**
             * Create a group
