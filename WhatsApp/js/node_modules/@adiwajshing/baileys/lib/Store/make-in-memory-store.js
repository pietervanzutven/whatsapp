require((exports, module) => {
    ...
    exports.default = ({ logger, chatKey }) => {
                ...
                switch (type) {
                    ...
                    case 'notify':
                        for (const msg of newMessages) {
                            ...
                            if (!store.chats.dict[jid]) {
                                store.chats.insert({ conversationTimestamp: 0, id: jid, unreadCount: 0 });
                            }
        ...
        return {
            ...
            fetchMessageInfo: async ({ remoteJid, id }, sock) => {
                if (!messageInfos[id]) {
                    messageInfos[id] = await (sock === null || sock === void 0 ? void 0 : sock.messageInfo(remoteJid, id));
                }
