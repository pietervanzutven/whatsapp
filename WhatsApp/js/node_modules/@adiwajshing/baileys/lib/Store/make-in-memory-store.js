require((exports, module) => {
    ...
    exports.default = ({ logger: _logger, chatKey }) => {
        const logger = _logger || Defaults_1.DEFAULT_CONNECTION_CONFIG.logger;
        ...
        return {
            ...
            mostRecentMessage: async (jid, sock) => {
                ...
                if (!message) {
                    const items = await (sock === null || sock === void 0 ? void 0 : sock.fetchMessagesFromWA(jid, 1, undefined));
                    message = items === null || items === void 0 ? void 0 : items[0];
                }
                return message;
            },
            ...
            fetchBroadcastListInfo: async (jid, sock) => {
                if (!groupMetadata[jid]) {
                    const metadata = await (sock === null || sock === void 0 ? void 0 : sock.getBroadcastListInfo(jid));
                    if (metadata) {
                        groupMetadata[jid] = metadata;
                    }
                }
            ...
            fetchMessageReceipts: async ({ remoteJid, id }, sock) => {
                ...
                let receipts = msg === null || msg === void 0 ? void 0 : msg.userReceipt;
                if (!receipts) {
