    ...
    const makeChatsSocket = (config) => {
        ...
        socketEvents.on('CB:Conn,pushname', json => {
            ...
            if (connection === 'open' && json[1].pushname !== user.name) {
                ...
                ev.emit('connection.update', { legacy: Object.assign({}, state.legacy, { user }) });
            }
        });
        // read updates
        ...
        return Object.assign({},
            sock,
            {
                ...
                updateBusinessProfile: async (profile) => {
                    ...
                    const json = ['action', 'editBusinessProfile', Object.assign({}, profile, { v: 2 })];
                ...
                updateProfileName: async (name) => {
                    ...
                    if (config.emitOwnEvents) {
                        const user = Object.assign({}, state.legacy.user, { name });
