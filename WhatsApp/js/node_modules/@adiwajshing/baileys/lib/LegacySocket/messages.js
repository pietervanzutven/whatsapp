require((exports, module) => {
    ...
    const makeMessagesSocket = (config) => {
        ...
        const generateUrlInfo = async (text) => {
            ...
            const urlInfo = Object.assign({}, response.attrs);
        ...
        const onMessageInfoUpdate = ([, attributes]) => {
            ...
            const updates = ids.map(id => ({
                key: Object.assign({}, keyPartial, { id }),
                update: {
                    [updateKey]: { [WABinary_1.jidNormalizedUser(attributes.participant || attributes.to)]: new Date(+attributes.t) }
                }
            }));
            ...
            sock,
            {
                ...
                sendMessage: async (jid, content, options = { waitForAck: true }) => {
                    ...
                    if (typeof content === 'object' &&
                        ...
                        const msg = await Utils_1.generateWAMessage(jid, content, Object.assign({},
                            {
                                logger,
                                userJid: userJid,
