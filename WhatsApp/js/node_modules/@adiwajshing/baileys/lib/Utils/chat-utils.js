require((exports, module) => {
    ...
    exports.syncActionUpdatesToEventMap = exports.processSyncAction = exports.chatModificationToAppPatch = exports.decodePatches = exports.decodeSyncdSnapshot = exports.downloadExternalPatch = exports.downloadExternalBlob = exports.extractSyncdPatches = exports.decodeSyncdPatch = exports.decodeSyncdMutations = exports.encodeSyncdPatch = exports.newAppStateChunk = exports.newLTHashState = void 0;
    ...
    const newAppStateChunk = (collectionsToHandle) => ({
        updates: {
            chatUpdates: {},
            credsUpdates: {},
            chatDeletes: [],
    ...
    exports.newAppStateChunk = newAppStateChunk;
    const encodeSyncdPatch = async ({ type, index, syncAction, apiVersion, operation }, myAppStateKeyId, state, getAppStateSyncKey) => {
        ...
        state = Object.assign({}, state, { indexValueMap: Object.assign({}, state.indexValueMap) });
    ...
    const processSyncAction = (syncAction, { credsUpdates, chatUpdates, chatDeletes, contactUpserts, msgDeletes, msgUpdates }, me, initialSyncOpts, logger) => {
        var _a, _b, _c, _d;
        ...
        if (action === null || action === void 0 ? void 0 : action.muteAction) {
            ...
            if (isValidPatchBasedOnMessageRange(id, archiveAction.messageRange)
                ...
                if (isInitialSync && !archiveAction.archived) {
                    ...
                    update.archive = !!(archiveAction === null || archiveAction === void 0 ? void 0 : archiveAction.archived);
                }
            }
        }
            ...
            if (isValidPatchBasedOnMessageRange(id, markReadAction.messageRange)
                ...
                if (isInitialSync && markReadAction.read) {
                    ...
                    update.unreadCount = !!(markReadAction === null || markReadAction === void 0 ? void 0 : markReadAction.read) ? 0 : -1;
                }
            }
        }
            ...
            contactUpserts[id] = Object.assign({},
                (contactUpserts[id] || {}),
                {
                    id,
            ...
            if ((me === null || me === void 0 ? void 0 : me.name) !== (action === null || action === void 0 ? void 0 : action.pushNameSetting)) {
                credsUpdates.me = Object.assign({}, me, { name: (_b = action === null || action === void 0 ? void 0 : action.pushNameSetting) === null || _b === void 0 ? void 0 : _b.name });
            }
        }
        else if (action === null || action === void 0 ? void 0 : action.pinAction) {
            update.pin = ((_c = action.pinAction) === null || _c === void 0 ? void 0 : _c.pinned) ? (0, generics_1.toNumber)(action.timestamp) : null;
        }
        ...
        else if (action === null || action === void 0 ? void 0 : action.starAction) {
            const uqId = `${id},${msgId}`;
            const update = msgUpdates[uqId] || {
                key: { remoteJid: id, id: msgId, fromMe: fromMe === '1' },
                update: {}
            };
            update.update.starred = !!((_d = action.starAction) === null || _d === void 0 ? void 0 : _d.starred);
            msgUpdates[uqId] = update;
        }
        else if (action === null || action === void 0 ? void 0 : action.deleteChatAction) {
            chatDeletes.push(id);
        }
        else {
        ...
        if (Object.keys(update).length > 1) {
            chatUpdates[update.id] = Object.assign({},
            ...
            logger === null || logger === void 0 ? void 0 : logger.debug({ id: update.id }, 'cancelling update');
    ...
    const syncActionUpdatesToEventMap = ({ credsUpdates, chatUpdates, chatDeletes, contactUpserts, msgDeletes, msgUpdates }) => {
        const map = {};
    ...
    exports.syncActionUpdatesToEventMap = syncActionUpdatesToEventMap;
});