require((exports, module) => {
    ...
    function consolidateEvents(data) {
        ...
        const messageReactionList = Object.values(data.messageReactions).flatMap((reactionData) => reactionData.reactions.flatMap(reaction => ({ key: reactionData.key, reaction })));
        if (messageReactionList.length) {
            map['messages.reaction'] = messageReactionList;
        }
        const messageReceiptList = Object.values(data.messageReceipts).flatMap((receiptData) => receiptData.userReceipt.flatMap(receipt => ({ key: receiptData.key, receipt })));
