require((exports, module) => {
    ...
    const prepareWAMessageMedia = async (message, options) => {
        ...
        if (cacheableKey) {
            ...
            if (mediaBuff) {
                ...
                Object.assign(obj[key], Object.assign({}, uploadData, { media: undefined }));
                return obj;
            }
        }
    ...
    const generateWAMessageContent = async (message, options) => {
        ...
        if ('text' in message) {
            ...
            m.productMessage = Types_1.WAProto.Message.ProductMessage.fromObject(Object.assign({},
                message,
                {
        ...
        if ('buttons' in message && !!message.buttons) {
            const buttonsMessage = {
                buttons: message.buttons.map(b => (Object.assign({}, b, { type: WAProto_1.proto.Message.ButtonsMessage.Button.Type.RESPONSE })))
            };
            if ('text' in message) {
