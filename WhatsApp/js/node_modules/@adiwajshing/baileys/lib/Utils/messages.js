require((exports, module) => {
    ...
    exports.assertMediaContent = exports.downloadMediaMessage = exports.aggregateMessageKeysNotFromMe = exports.updateMessageWithReceipt = exports.getDevice = exports.extractMessageContent = exports.normalizeMessageContent = exports.getContentType = exports.generateWAMessage = exports.generateWAMessageFromContent = exports.generateWAMessageContent = exports.generateForwardMessageContent = exports.prepareDisappearingMessageSettingContent = exports.prepareWAMessageMedia = exports.generateLinkPreviewIfRequired = void 0;
    ...
    const generateLinkPreviewIfRequired = async (text, getUrlInfo, logger) => {
        const matchedUrls = text.match(Defaults_1.URL_REGEX);
    ...
    const prepareWAMessageMedia = async (message, options) => {
        ...
        if (cacheableKey) {
            ...
            if (mediaBuff) {
                ...
                Object.assign(obj[key], Object.assign({}, uploadData ));
                return obj;
            }
        }
        ...
        const obj = Types_1.WAProto.Message.fromObject({
            [`${mediaType}Message`]: MessageTypeProto[mediaType].fromObject(Object.assign({},
                {
                    url: mediaUrl,
                    directPath,
                    mediaKey,
    ...
    const generateWAMessageContent = async (message, options) => {
            ...
            switch (message.type) {
                ...
                case 'plain':
                    m.buttonsResponseMessage = {
                        ...
                        selectedDisplayText: message.buttonReply.displayText,
                        type: WAProto_1.proto.ButtonsResponseMessage.ButtonsResponseMessageType.DISPLAY_TEXT,
                    };
                    break;
            }
        }
        ...
        if ('buttons' in message && !!message.buttons) {
            const buttonsMessage = {
                buttons: message.buttons.map(b => (Object.assign({}, b, { type: WAProto_1.proto.Button.ButtonType.RESPONSE })))
            };
            if ('text' in message) {
    ...
    const generateWAMessageFromContent = (jid, message, options) => {
        ...
        if (
            ...
            message[key].contextInfo = Object.assign({},
