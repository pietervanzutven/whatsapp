require((exports, module) => {
    ...
    const makeMessagesRecvSocket = (config) => {
        ...
        const processMessage = async (message, chatUpdate) => {
            ...
            if (protocolMsg) {
                ...
                const emitGroupUpdate = (update) => {
                    ev.emit('groups.update', [Object.assign({}, { id: jid }, update)]);
                };
        ...
        const sendMessagesAgain = async (key, ids) => {
            const msgs = await Promise.all(ids.map(id => (config.getMessage(Object.assign({}, key, { id })))));
                ...
                for (const msg of messages) {
                    if (!!msg.pushName) {
                        ...
                        if (msg.key.fromMe && ((_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.name) !== msg.pushName) {
                            ev.emit('creds.update', { me: Object.assign({}, authState.creds.me, { name: msg.pushName }) });
                        }
                    }
        ...
        return Object.assign({}, sock, { processMessage, sendMessageAck, sendRetryRequest });
    };
