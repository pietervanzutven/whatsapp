        ...
        const processSyncActions = (actions) => {
            ...
            for (const { syncAction: { value: action }, index: [_, id, msgId, fromMe] } of actions) {
                ...
                if (action === null || action === void 0 ? void 0 : action.muteAction) {
                    ...
                    contactUpdates[id] = Object.assign({},
                        (contactUpdates[id] || {}),
                        {
                            id,
                ...
                if (Object.keys(update).length > 1) {
                    updates[update.id] = Object.assign({},
                        (updates[update.id] || {}),
                        update
                    );
                }
        ...
        const appPatch = async (patchCreate) => {
            ...
            await mutationMutex.mutex(async () => {
                ...
                if (config.emitOwnEvents) {
                    const result = await Utils_1.decodePatches(name, [Object.assign({}, patch, { version: { version: state.version } })], initial, getAppStateSyncKey);
