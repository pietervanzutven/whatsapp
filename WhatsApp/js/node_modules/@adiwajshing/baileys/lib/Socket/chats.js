    ...
    const makeChatsSocket = (config) => {
        ...
        const appPatch = async (patchCreate) => {
            ...
            if (config.emitOwnEvents) {
                ...
                await (0, Utils_1.decodePatches)(name, [Object.assign({}, encodeResult.patch, { version: { version: encodeResult.state.version }, })], initial, getAppStateSyncKey, onMutation, undefined, logger);
            }
        };
