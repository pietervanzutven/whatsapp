require((exports, module) => {
     ...
     */
    const makeSocket = ({ waWebSocketUrl, connectTimeoutMs, logger, agent, keepAliveIntervalMs, version, browser, auth: authState, printQRInTerminal, defaultQueryTimeoutMs, transactionOpts }) => {
        ...
        const end = (error) => {
            logger.info({ error, trace: error === null || error === void 0 ? void 0 : error.stack }, error ? 'connection errored' : 'connection closed');
        ...
        ws.on('error', error => end(new boom_1.Boom(`WebSocket Error (${error.message})`, { statusCode: 500, data: error })));
